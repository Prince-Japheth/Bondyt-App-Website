...
export function DownloadButtons() {
    return (
        <motion.div variants={fadeInUp} className="mt-16 flex justify-center space-x-4">
            <button className="flex items-center rounded-full bg-[#212121] px-7 py-3 text-white transition-all hover:border-2 hover:border-[#0086c9]">
                <Image
...
export function HeroDownloadButtons() {
    return (
        <motion.div variants={fadeInUp} className="mb-16 flex justify-center gap-4">
            <button className="flex items-center gap-2 rounded-full bg-[#111827] px-6 py-2 text-white transition border-4 border-transparent hover:border-[#0086c9]">
                <Image
                    src="https://cdn-icons-png.flaticon.com/128/16509/16509899.png"
                    alt="App Store"
                    width={24}
